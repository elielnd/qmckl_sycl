...
am__libqmckl_gpu_la_SOURCES_DIST = src/qmckl_context.cpp \
	...
	src/qmckl_jastrow.cpp src/qmckl_trexio.cpp
...
am_libqmckl_gpu_la_OBJECTS = src/qmckl_context.lo \
	...
	src/qmckl_nucleus.lo src/qmckl_ao.lo src/qmckl_mo.lo \
	src/qmckl_jastrow.lo $(am__objects_1)
...
ACLOCAL = ${SHELL} /home/enditar/qmckl_sycl/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/enditar/qmckl_sycl/missing autoconf
AUTOHEADER = ${SHELL} /home/enditar/qmckl_sycl/missing autoheader
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/enditar/qmckl_sycl/missing makeinfo
MANIFEST_TOOL = :
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /opt/intel/oneapi/vtune/2023.0.0/include/pkgconfig/lib64:/opt/intel/oneapi/vpl/2023.0.0/lib/pkgconfig:/opt/intel/oneapi/tbb/2021.10.0/env/../lib/pkgconfig:/opt/intel/oneapi/mpi/2021.10.0/lib/pkgconfig:/opt/intel/oneapi/mkl/2023.2.0/lib/pkgconfig:/opt/intel/oneapi/ippcp/2021.6.3/lib/pkgconfig:/opt/intel/oneapi/inspector/2023.1.0/include/pkgconfig/lib64:/opt/intel/oneapi/dpl/2022.2.0/lib/pkgconfig:/opt/intel/oneapi/dnnl/2023.0.0/cpu_dpcpp_gpu_dpcpp/../lib/pkgconfig:/opt/intel/oneapi/dal/2023.0.0/lib/pkgconfig:/opt/intel/oneapi/compiler/2023.2.0/lib/pkgconfig:/opt/intel/oneapi/ccl/2021.10.0/lib/pkgconfig:/opt/intel/oneapi/advisor/2023.0.0/include/pkgconfig/lib64:
RANLIB = ranlib
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/bash
...
TREXIO_LIBS = 
VERSION = 0.0.1
abs_builddir = /home/enditar/qmckl_sycl
abs_srcdir = /home/enditar/qmckl_sycl
abs_top_builddir = /home/enditar/qmckl_sycl
abs_top_srcdir = /home/enditar/qmckl_sycl
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = icpx
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/enditar/qmckl_sycl/install-sh
...
libqmckl_gpu_la_SOURCES = src/qmckl_context.cpp \
	...
	src/qmckl_memory.cpp src/qmckl_blas.cpp src/qmckl_electron.cpp \
	src/qmckl_nucleus.cpp src/qmckl_ao.cpp src/qmckl_mo.cpp \
	src/qmckl_jastrow.cpp $(am__append_1)
