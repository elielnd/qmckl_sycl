...
// 	double *elec_coord_d =
// 		reinterpret_cast<double *>(qmckl_malloc_device(context, point_num * 3 * sizeof(double)));
// 	double *nucl_charge_d =
// 		reinterpret_cast<double *>(qmckl_malloc_device(context, nucl_num * sizeof(double)));
// 	double *nucl_coord_d =
		

// interpret_cast<double *>(qmckl_malloc_device(context, nucl_num * 3 * sizeof(double)));
...
// 	double *ao_value = reinterpret_cast<double *>(malloc(point_num * ao_num * sizeof(double)));
// 	double *ao_value_d =
...
// = qmckl_set_mo_basis_mo_num_device(context, mo_num);
// 	assert(rc == QMCKL_SUCCESS);

// 	double *mo_coefficient = &(chbrclf_mo_coef[0]);
// 	double *mo_coefficient_d =
// 		reinterpret_cast<double *>(qmckl_malloc_device(context, mo_num * ao_num * sizeof(double)));
...
// 	double *mo_value = reinterpret_cast<double *>(malloc(point_num * chbrclf_mo_num * sizeof(double)));
// 	double *mo_value_d = reinterpret_cast<double *>(qmckl_malloc_device(
...
// /**/
// 	double *mo_vgl = reinterpret_cast<double *>(malloc(point_num * 5 * chbrclf_mo_num * sizeof(double)));
// 	double *mo_vgl_d = reinterpret_cast<double *>(qmckl_malloc_device(
