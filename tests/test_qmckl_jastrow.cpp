...
int main() {
	...
	double *elec_coord = reinterpret_cast<double *>(qmckl_malloc_device(context, sizeof(n2_elec_coord)));
	qmckl_memcpy_H2D(context, elec_coord, n2_elec_coord, sizeof(n2_elec_coord));

	// double *nucl_charge = n2_charge;
	double *nucl_charge = reinterpret_cast<double *>(qmckl_malloc_device(context, sizeof(n2_charge)));
	qmckl_memcpy_H2D(context, nucl_charge, n2_charge, sizeof(n2_charge));

	// double *nucl_coord = &(n2_nucl_coord[0][0]);
	double *nucl_coord = reinterpret_cast<double *>(qmckl_malloc_device(context, sizeof(n2_nucl_coord)));
	...
	double *elec_coord2 =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * 3 * elec_num * sizeof(double)));
...
// 	double *factor_en = reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * sizeof(double)));
...
// check factor_en_deriv_e
	...
	double *en_distance_rescaled = reinterpret_cast<double *>(qmckl_malloc_device(
	...
	double *en_distance_rescaled_deriv_e = reinterpret_cast<double *>(qmckl_malloc_device(
	...
	double *een_rescaled_e =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * (cord_num + 1) * elec_num *
	...
	double *een_rescaled_e_deriv_e =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * (cord_num + 1) * elec_num * 4 *
	...
	double *een_rescaled_n =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * (cord_num + 1) * nucl_num *
										 elec_num * sizeof(double)));
	...
	double *een_rescaled_n_deriv_e =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * (cord_num + 1) * nucl_num * 4 *
										 elec_num * sizeof(double)));
...
// value of (0,2,1)
	...
	double *tmp_c =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * cord_num * (cord_num + 1) *
	...
	double *factor_een =
		reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * sizeof(double)));
	...
	double *factor_een_deriv_e =
		reinterpret_cast<double *>(qmckl_malloc_device(context, 4 * walk_num * elec_num * sizeof(double)));
	...
	rc = qmckl_get_jastrow_factor_en_device(context, factor_en, walk_num);
	rc = qmckl_get_jastrow_factor_een_device(context, factor_een, walk_num);
	double *total_j = reinterpret_cast<double *>(qmckl_malloc_device(context, walk_num * sizeof(double)));
