// #include "../include/qmckl_trexio.hpp"

// //**********
// // TREXIO CONTEXT FILL
// //**********

// qmckl_exit_code_device qmckl_trexio_read_electron_X_device(qmckl_context_device context, trexio_t *file)
// {
...
//         double *nucl_charge_d = (double *)qmckl_malloc_device(context, nucleus_num * sizeof(double));
...
//         rc = qmckl_set_nucleus_charge_device(context, nucl_charge_d, nucleus_num);
...
//     rc = qmckl_set_nucleus_coord_device(context, 'N', nucl_coord_d, 3 * nucleus_num);
...
//         int64_t *nucleus_index_h = (int64_t *)qmckl_malloc_host(context, mem_info);
//         int64_t *nucleus_index_d = (int64_t *)qmckl_malloc_device(context, nucleus_num * sizeof(int64_t));
...
//         qmckl_memcpy_H2D(context, nucleus_index_d, nucleus_index_h, size_backup);

//         qmckl_free_host(context, tmp_array);
//         tmp_array = NULL;

//         /* Store data */
//         rc = qmckl_set_ao_basis_nucleus_index_device(context, nucleus_index_d, shell_num);
...
//         int64_t *nucleus_shell_num_h = (int64_t *)qmckl_malloc_host(context, mem_info);
//         int64_t *nucleus_shell_num_d = (int64_t *)qmckl_malloc_device(context, nucleus_num * sizeof(int64_t));
...
//         /* Store data */
//         qmckl_memcpy_H2D(context, nucleus_shell_num_d, nucleus_shell_num_h, size_backup);
//         rc = qmckl_set_ao_basis_nucleus_shell_num_device(context, nucleus_shell_num_d, shell_num);
...
//         int32_t *shell_ang_mom_h = (int32_t *)qmckl_malloc_host(context, mem_info);
...
//         int64_t *shell_prim_num_h = (int64_t *)qmckl_malloc_host(context, mem_info);
...
//         /* Store data */
//         qmckl_memcpy_H2D(context, shell_prim_num_d, shell_prim_num_h, size_backup);
...
//         int64_t *shell_prim_index_h = (int64_t *)qmckl_malloc_host(context, mem_info);
...
//         /* Store data */
//         qmckl_memcpy_H2D(context, shell_prim_index_d, shell_prim_index_h, size_backup);
...
//         double *ao_normalization_h = (double *)qmckl_malloc_host(context, mem_info);
//         double *ao_normalization_d = (double *)qmckl_malloc_device(context, ao_num * sizeof(double));
...
//         /* Read data */
//         rcio = trexio_read_safe_ao_normalization_64(file, ao_normalization_h, ao_num);
//         if (rcio != TREXIO_SUCCESS)
//         {
