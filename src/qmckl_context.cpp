...
//**************
// Others functions, not included in the header file
//**************
...
qmckl_exit_code_device qmckl_context_touch_device(const qmckl_context_device context)
{
    ...
    if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
    {
        return qmckl_failwith_device(context, QMCKL_INVALID_CONTEXT_DEVICE,
                                     "qmckl_context_touch_device", nullptr);
    }
...
qmckl_context_device qmckl_context_create_device(queue q)
{
    ...
    /* Allocate the host qmckl_memory_struct */
    {
        ...
        qmckl_memory_info_struct_device *new_array = new (std::nothrow) qmckl_memory_info_struct_device[size]();
...
qmckl_exit_code_device qmckl_context_destroy_device(const qmckl_context_device context)
{
    ...
    ctx->memory_device.element = nullptr;
