...
qmckl_exit_code_device qmckl_provide_ao_basis_ao_vgl_device(qmckl_context_device context)
{
	...
	if (ctx->point.date > ctx->ao_basis.ao_vgl_date)
	{
		...
		if (ctx->ao_basis.ao_vgl == NULL)
		{
			...
			double *ao_vgl = (double *)qmckl_malloc_device(context,
		...
		if (ctx->ao_basis.shell_vgl == NULL || ctx->point.date > ctx->ao_basis.shell_vgl_date)
		{
...
qmckl_exit_code_device qmckl_get_ao_basis_shell_vgl_device(qmckl_context_device context,
														...
														double *const ao_vgl, const int64_t size_max)
{
	...
	qmckl_context_struct_device *const ctx = (qmckl_context_struct_device *)context;
	assert(ctx != NULL);
	sycl::queue q = qmckl_get_device_queue(context);
...
qmckl_exit_code_device qmckl_get_ao_basis_ao_value_inplace_device(qmckl_context_device context,
																  double *const ao_value,
																  const int64_t size_max)
{
...
qmckl_exit_code_device qmckl_set_ao_basis_type_device(qmckl_context_device context, char basis_type)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
		return qmckl_failwith_device(context, QMCKL_INVALID_CONTEXT_DEVICE,
...
qmckl_exit_code_device qmckl_set_ao_basis_shell_num_device(qmckl_context_device context,
														   int64_t shell_num)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
...
qmckl_exit_code_device qmckl_set_ao_basis_ao_num_device(qmckl_context_device context, int64_t ao_num)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
		return qmckl_failwith_device(context, QMCKL_INVALID_CONTEXT_DEVICE,
...
qmckl_exit_code_device qmckl_set_ao_basis_nucleus_index_device(qmckl_context_device context, int64_t *nucleus_index, int64_t size_max)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
		return qmckl_failwith_device(context, QMCKL_INVALID_CONTEXT_DEVICE,
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.nucleus_index);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(
...
qmckl_exit_code_device qmckl_set_ao_basis_nucleus_shell_num_device(qmckl_context_device context,
																   ...
																   int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.nucleus_shell_num);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_nucleus_shell_num_device",
										 NULL);
		}
	}
...
qmckl_exit_code_device qmckl_set_ao_basis_shell_ang_mom_device(qmckl_context_device context, int32_t *shell_ang_mom, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.shell_ang_mom);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_shell_ang_mom_device", NULL);
		}
	}
...
qmckl_exit_code_device qmckl_set_ao_basis_shell_prim_num_device(qmckl_context_device context, int64_t *shell_prim_num, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.shell_prim_num);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(
...
qmckl_exit_code_device qmckl_set_ao_basis_shell_prim_index_device(qmckl_context_device context, int64_t *shell_prim_index, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.shell_prim_index);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_shell_prim_index_device",
										 NULL);
		}
	}
...
qmckl_exit_code_device qmckl_set_ao_basis_shell_factor_device(qmckl_context_device context,
															  double *shell_factor, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.shell_factor);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_shell_factor_device", NULL);
		}
	}
														  ...
														  double *exponent, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.exponent);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_exponent_device", NULL);
		}
	}
...
qmckl_exit_code_device qmckl_set_ao_basis_coefficient_device(qmckl_context_device context,
															 double *coefficient, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.coefficient);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_coefficient_device", NULL);
		}
	}
															 ...
															 double *prim_factor, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.prim_factor);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_prim_factor_device", NULL);
		}
	}
...
qmckl_exit_code_device qmckl_set_ao_basis_ao_factor_device(qmckl_context_device context,
														   double *ao_factor, int64_t size_max)
{
	...
	{
		qmckl_exit_code_device rc = qmckl_free_device(context, ctx->ao_basis.ao_factor);
		if (rc != QMCKL_SUCCESS_DEVICE)
		{
			return qmckl_failwith_device(context, rc, "qmckl_set_ao_basis_ao_factor_device", NULL);
		}
	}
...
qmckl_exit_code_device qmckl_get_ao_basis_ao_num_device(const qmckl_context_device context,
														int64_t *ao_num)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
...
qmckl_exit_code_device qmckl_get_ao_basis_shell_num_device(const qmckl_context_device context,
...
qmckl_exit_code_device qmckl_get_ao_basis_prim_num_device(const qmckl_context_device context,
														  int64_t *prim_num)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
...
qmckl_exit_code_device qmckl_get_ao_basis_nucleus_shell_num_device(qmckl_context_device context,
																   int64_t *nucleus_shell_num,
																   int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_nucleus_index_device(qmckl_context_device context,
															   int64_t *nucleus_index, int64_t size_max)
...
qmckl_exit_code_device qmckl_get_ao_basis_shell_ang_mom_device(qmckl_context_device context,
															   int32_t *shell_ang_mom, int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_shell_prim_num_device(qmckl_context_device context,
																int64_t *shell_prim_num, int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_shell_prim_index_device(qmckl_context_device context, int64_t *shell_prim_index, int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_coefficient_device(qmckl_context_device context,
															 double *coefficient, int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_prim_factor_device(qmckl_context_device context,
															 double *prim_factor, int64_t size_max)
{
...
qmckl_exit_code_device qmckl_get_ao_basis_ao_factor_device(qmckl_context_device context,
														   double *ao_factor, int64_t size_max)
{
	if (qmckl_context_check_device(context) == QMCKL_NULL_CONTEXT_DEVICE)
	{
